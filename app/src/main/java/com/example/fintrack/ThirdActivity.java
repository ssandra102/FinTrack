...
public class ThirdActivity extends AppCompatActivity {
    ...
    Button cameraBtn,gotoResults, submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoResults.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(ThirdActivity.this, ResultsActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void uploadImageToFirebase(String name, Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(ThirdActivity.this, "Image Is Uploaded.", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ThirdActivity.this, "Upload Failled.", Toast.LENGTH_SHORT).show();
            }
        });
